...
- **Dev Server URL**: `http://127.0.0.1:5229`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/66c427ce-8c2d-4c9e-b468-824fe8c190f1/preview`
- **Port**: `5229`
...
4. The dev server is accessible at `http://127.0.0.1:5229`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/66c427ce-8c2d-4c9e-b468-824fe8c190f1/preview`
